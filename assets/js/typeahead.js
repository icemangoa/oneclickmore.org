 ...
 */
  ...
  .directive('typeaheadPopup', function () {
    return {
      ...
      replace:true,
      templateUrl:'assets/js/template/typeahead/typeahead.html',
...
.filter('typeaheadHighlight', function() {
    ...
    return function(matchIdx, query) {
      return query ? matchIdx.replace(new RegExp(escapeRegexp(query), 'gi'), '<strong>$&</strong>') : query;
    };
  });